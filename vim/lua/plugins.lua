...
require('lazy').setup({
  ...
  -- ファイラー (Defx)
  {
    ...
    config = function()
      vim.keymap.set('n', '<Leader>e', function()
        ...
        vim.cmd('Defx -auto-cd -toggle -resume -columns=mark:indent:icon:filename:type:size:time -split=vertical -winwidth=35')
      end)
  ...
  -- LSP関係
  {
    ...
    config = function()
      ...
      -- 他のサーバー
      local servers = { 'ruby_lsp', 'marksman', 'jsonls', 'yamlls' }
